...
public class EditUI extends JFrame {
    ...
    private void onSaveChanges() {
        ...
        if (classroom.isAvailable(newDate, newTimeSlot)) {
            Booking newBooking = new Booking(teacher,newDate,newTimeSlot,newCourse,newCode,classroom.getName(),"R" + System.currentTimeMillis(),reservationType);
            reservationSystem.makeReservation(teacher,classroom,newTimeSlot,reservationType, newDate.getYear(), newDate.getMonth(),newDate.getDayOfMonth(),newCourse,newCode);
            dataManager.addBooking(teacher,newBooking);
