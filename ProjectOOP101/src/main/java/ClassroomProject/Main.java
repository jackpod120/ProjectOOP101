...
public class Main {
    public static void main(String[] args) {
        ...
        Classroom room102 = new Classroom("102");
        Classroom room103 = new Classroom("103");
        reservationSys.addClassroom(room101);
        reservationSys.addClassroom(room102);
        reservationSys.addClassroom(room103);
        ...
        if (teacherSomchai != null) {
            ...
            reservationSys.makeReservation(teacherSomchai, room101, mondayMorning, ReservationType.MONTHLY, 2025, Month.AUGUST,"Mathematics","123456789");
        }
        ...
        if (teacherSomying != null) {
            ...
            reservationSys.makeReservation(teacherSomying, room101, mondayMorningOverlap, ReservationType.MONTHLY, 2025, Month.AUGUST,"English","987654321");

            // อาจารย์สมหญิงจองวันพุธบ่ายทั้งเทอม (เริ่มเดือนสิงหาคม) -> ควรสำเร็จ
            System.out.println("\n" + teacherSomying.getName() + " กำลังพยายามจองใหม่...");
            reservationSys.makeReservation(teacherSomying, room101, wednesdayAfternoon, ReservationType.TERM, 2025, Month.AUGUST,"Computer","0000000000");
        }
        System.out.println();
